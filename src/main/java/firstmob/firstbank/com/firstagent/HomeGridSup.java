...
public class HomeGridSup extends Fragment implements View.OnClickListener {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.newvershomegridsup, null);
    ...
    public void  swithgrid(){
        ...
        // ((SupHomeActivity)getActivity()).addFragment(fragment,title);
                                ...
                                if (!(Utility.checkUserLocked(respcode))) {
                                  ...
                                  /*  getActivity().finish();
                                    ...
                                    Toast.makeText(
                                            ...
                                            Toast.LENGTH_LONG).show();*/
                                    if(!(getActivity() == null)) {
                                        ((SupHomeActivity) getActivity()).LogOut();
                                    }
                                }
                            } else {
...
*/
                        ...
                        if(!(getActivity() == null)) {
                            Toast.makeText(getActivity(), getActivity().getText(R.string.conn_error), Toast.LENGTH_LONG).show();
                            ((SupHomeActivity) getActivity()).SetForceOutDialog(getString(R.string.forceout), getString(R.string.forceouterr), getActivity());
...
public void checkAppvers(){
    ...
    public void onResume() {
        super.onResume();
        ((SupHomeActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#ffffff")));

    }
    @Override
    public void onStop() {
        super.onStop();
        ((SupHomeActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#f5f5f5")));
