...
public class WithdrawalMenuActivity extends BaseActivity {
    GridView gridView;
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    startActivity(new Intent(WithdrawalMenuActivity.this, WithdrawActivity.class));
                } else if (position == 1) {


                    startActivity(new Intent(WithdrawalMenuActivity.this, ValidateToken.class));
                }
    ...
    public void SetPop(){
       ...
       *//* planetsList.add(new Dashboard("My Profile",R.drawable.icons40));*//*
        ...
        planetsList.add(new OTBList("Withdraw from  FirstBank account","057"));
